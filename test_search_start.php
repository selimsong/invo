...
echo "<font color='red'>&nbsp; &nbsp;&nbsp;&nbsp; Just click the Maximize ,then you can see the Search Bar form , Just click the Submit button  don't need choose any options , 
    <br />
   the data   starting sept 2009 – May 2010 </font>";
echo "<br />
$sqlWhere";
...
$page->setFileName("test_search_start.php?orderBy=" . $fileNames);

$_SESSION["sqlWhere"] = $sqlWhere;
$_SESSION["search_url"] = "test_search_start.php?orderBy=" . $fileNames;
...
$invoiceTpl->display("test_search_list.htm");
//print_r($db);
?>